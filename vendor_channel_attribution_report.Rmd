...
```{r echo=FALSE, eval=FALSE}
# prc=prcomp(data_wide[2:8], center = TRUE,
                 # scale. = TRUE) 
# plot(prc, type = "l")
# summary(prc)
...
The regularized regression classification model had an accuracy of 0.7505 on the training data, 0.745 on the testing data, and 0.748 on all data.
```{r echo=FALSE}
